...
# -----------------------------
# 4) Restore BankPortalDb from backup
# -----------------------------
Write-Section "Restoring BankPortalDb database from backup"
$backupUrl     = "https://github.com/Mr-MSFT/Training/raw/refs/heads/main/BankPortalDb.bak"
$backupBakPath = Join-Path $WorkingDir "BankPortalDb.bak"
...
$relocateData = New-Object Microsoft.SqlServer.Management.Smo.RelocateFile("BankPortalDb",      "$dataDir\BankPortalDb.mdf")
$relocateLog  = New-Object Microsoft.SqlServer.Management.Smo.RelocateFile("BankPortalDb_log",  "$dataDir\BankPortalDb_log.ldf")
...
Write-Host "Database 'BankPortalDb' restored successfully."
